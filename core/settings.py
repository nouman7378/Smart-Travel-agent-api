...
SECRET_KEY = 'django-insecure-mt5e=iuws1c!4xb)7zxvl1z#k*y_wpy9mqi6g*rgt_-sbtc+4+'
...
# SQLite fallback (uncomment above and replace DATABASES with this to use SQLite):
# DATABASES = {
#     'default': {
